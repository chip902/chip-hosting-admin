//~~tv:19063.am2260.20240508
//~~tc: Added version 2.26.0


var instanceName = "##UTVARconfig_sobject##"
window[instanceName]=s_gi("##UTVARconfig_reportsuite##")
window[instanceName].account="##UTVARconfig_reportsuite##";

/************************** CONFIG SECTION **************************/
window[instanceName].trackDownloadLinks="##UTVARconfig_tracklinks##";
window[instanceName].trackExternalLinks="##UTVARconfig_tracklinks##";
window[instanceName].trackInlineStats=true;
window[instanceName].linkInternalFilters="##UTVARconfig_internalfilters##";
window[instanceName].linkLeaveQueryString=false;
window[instanceName].linkTrackVars="None";
window[instanceName].linkTrackEvents="None";
window[instanceName].usePlugins=false;
window[instanceName].currencyCode="USD"; // override default with E-Commerce Extension
window[instanceName].visitorNamespace = "##UTVARconfig_namespace##";
window[instanceName].trackingServer="##UTVARconfig_server##";
window[instanceName].trackingServerSecure="##UTVARconfig_serversecure##";
window[instanceName].charSet = "UTF-8";
window[instanceName].decodeLinkParameters = toBoolean("##UTVARconfig_decodeLinkParameters##") || false;

window[instanceName].expectSupplementalData=true;
window[instanceName].debugTracking=(utag.cfg) ? utag.cfg.utagdb : false;
...
//tealium universal tag - utag.sender.19063 v4.0.##UTVERSION##, Copyright ##UTYEAR## Tealium.com Inc. All Rights Reserved.
try{
    (function(id,loader){
        ...
        u.send=function(a,b,c,d,e,f,g,h,ev){
            if(u.ev[a]||typeof u.ev.all!="undefined"){
                ...
                u.data = {
                    ...
                    "linkName" : "",
                    "linkType" : "",
                    "runviewthrough" : "##UTVARconfig_runviewthrough##",
                    "viewthroughloaded" : u.hasadobeView(),
                    "viewthroughinterval" : "##UTVARconfig_viewthroughinterval##",
                    "viewthroughmaxtries" : "##UTVARconfig_viewthroughmaxtries##",
                    "clearVars_in_RPTCallback" : false,
                ...
                for (d in utag.loader.GV(u.map)) {
                    if (b[d] !== undefined && b[d] !== "") {
                        ...
                        for (f = 0; f < e.length; f++) {
                            if(
                                e[f] === "adobe_org_id" || e[f] === "linkTrackVars" ||
                                e[f] === "linkTrackEvents" || e[f] === "linkType" ||
                                e[f] === "linkName" || e[f] === 'collectHighEntropyUserAgentHints'
                            ){
                                u.data[e[f]] = b[d];
                ...
                vAPI.getInstance(u.data.adobe_org_id, function(instance) {
                    ...
                    if(u.data.runviewthrough === "yes"){
                        var editedReportSuite = "##UTVARconfig_reportsuite##".toLowerCase();
