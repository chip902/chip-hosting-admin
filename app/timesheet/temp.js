//~~tv:19063.am282.20180508
//~~tc: Update AppMeasurement to allow for Visitor API outside Tealium
    ...
    if(u.ev[a]||typeof u.ev.all!="undefined"){
      ...
      vAPI.getInstance(u.data.adobe_org_id, function(instance) {
        ...
        if("##UTVARconfig_runclearvars##"=="yes"){
          u.o.clearVars();
          u.o.contextData = {};
          // experimental blanking for SPA issues
          utag.data.sc_event_type='';
          utag.data.sc_event_type2='';
          utag.data.sc_event_type3='';
          utag.data.sc_event_type4='';
          utag.data.sc_event_type5='';
          utag.data.sc_event_type1_link='';
          utag.data.order_reference_id=undefined;
          utag.data.Instock_ATC=''; // might need to blank out so event8 doesn't persist
