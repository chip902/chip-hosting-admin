...
const CalendarToolbar = ({ title, onViewChange, onNavigate, currentView }: CalendarToolbarProps) => {
	...
	return (
		<div className="flex flex-col sm:flex-row items-center justify-between mb-4 gap-4 p-4">
			<div className="flex items-center gap-2">
				...
				<h2 className="ml-2 text-xl font-semibold text-gray-900 dark:text-gray-100">{title}</h2>
			</div>

			<Tabs value={getTabValue(currentView)} onValueChange={handleTabChange} className="w-full sm:w-auto">
	...
	return (
		<div className="flex flex-col h-screen">
			<div className="sticky top-0 z-10 bg-white dark:bg-gray-900 pb-4">
				<CalendarToolbar title={title} onViewChange={handleViewChange} onNavigate={handleNavigate} currentView={currentView} />
			</div>

			<div className="flex-grow rounded-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800">
				<FullCalendar
					ref={calendarRef}
