			...
			<Link href="/" className="bank-card">
				<div className="bank-card_content">
					<div>
						...
						<p className="font-ibm-plex-serif font-black text-white">{formatAmount(account.currentBalance || 0)}</p>
					</div>
				...
				<Image className="absolute top-0 left-0" src="/icons/lines.png" width={60} height={190} alt="lines" />
			</Link>
