...
const TransactionImporter: React.FC<TransactionImporterProps> = ({ userId, onImportSuccess }) => {
	...
	// Mutation for syncing Plaid transactions
	const syncMutation = useMutation({
		...
		onSuccess: () => {
			...
			setUploadStatus({
				status: "success",
				message: "Successfully synced transactions from Plaid",
			});
		},
		onError: (error) => {
			setUploadStatus({
				status: "error",
				message: "Failed to sync transactions: " + (error as Error).message,
			});
		},
	});
